...
class DetailRujukan extends Controller
{
    public function index(Request $request, $id)
    {
        $data = LaporanKasusPpa::where('id', $id)->firstOrFail();
        return view('detail_rujukan', compact('data'));
    }
    ...
    public function save(Request $request, $id)
    {
        $request->validate([
            ...
            'address_instance'  => 'required|string|max:255',
            'nama_korban'       => 'required|string|max:255',
            'nama_pelaku'       => 'required|string|max:255',
            'gender_korban'     => 'required|in:Laki-laki,Perempuan',
            'gender_pelaku'     => 'required|in:Laki-laki,Perempuan',
            'usia_pelaku'       => 'required|integer|min:1',
            ...
            'instance.required'         => 'Nama instansi wajib diisi.',
            'address_instance.required' => 'Alamat instansi wajib diisi.',
