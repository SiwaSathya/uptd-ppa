            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form action="/detail_rujukan/{{ $data->id }}/save" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="{{ $data->id_kasus_formatted }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="instance"
                                                ...
                                                value="{{ old('instance', $data->instance) }}"
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="address_instance"
                                                ...
                                                value="{{ old('address_instance', $data->address_instance) }}"
                            ...
                            <form id="form-hapus-{{ $data->id }}"
                                action="/detail_rujukan/{{ $data->id }}/delete"
                                method="POST"
                                style="display:none;">
                                @csrf
                                @method('DELETE')
    ...
    function konfirmasiHapus(id) {
        if (confirm('Apakah Anda yakin ingin menghapus data ini?\nData tidak akan hilang permanen dan masih bisa dipulihkan.')) {
            ...
            if (form) {
                ...
                alert('Form hapus tidak ditemukan! ID: form-hapus-' + id);
            }
        }
    }
